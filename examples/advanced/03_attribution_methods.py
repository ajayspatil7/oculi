...
def main():
    ...
    # === 1. Attention Flow ===
    print("\n" + "=" * 70)
    print("1⃣  Attention Flow - Track information propagation")
    print("=" * 70)
    ...
    print("\n" + "=" * 70)
    print("2⃣  Value-Weighted Attention - Account for value magnitudes")
    print("=" * 70)
    ...
    print("\n" + "=" * 70)
    print("4⃣  Component Attribution - Attention vs MLP")
    print("=" * 70)
    ...
    print("\n" + "=" * 70)
    print("5⃣  Top Attributions - Extract most important contributors")
    print("=" * 70)
